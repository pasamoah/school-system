                                    ...
                                    <li>
                                        ...
                                        <div class="activity-content">
                                            <div class="timeline-content">
                                                <a href="profile.html" class="name">Course code</a> <?php echo $assign->ass_course_code; ?> <a href="#"><?php echo $assign->ass_course_name; ?></a>
                                                <span class="time">4 mins ago | <a href="/assignment/edit/<?php echo $assign->id; ?>"> <i class="fa fa-pencil m-r-5"></i> Edit</a> </span>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\management\school\resources\views/all-assignments.blade.php ENDPATH**/ ?>