            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu" style="text-decoration: none;">
                    <ul>
                        ...
                        <li class="submenu">
                          <a href="#" class="<?php echo e(request()->is('*exams-list*') ? 'menu-open' : ''); ?>"><i class="fa fa-pencil"></i> <span> Academics </span> <span class="menu-arrow"></span></a>
...
<script type="text/javascript">
  ...
  <script src="<?php echo e(asset('assets/js/popper.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/jquery.slimscroll.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\apps\school\resources\views/inc/sidebar.blade.php ENDPATH**/ ?>