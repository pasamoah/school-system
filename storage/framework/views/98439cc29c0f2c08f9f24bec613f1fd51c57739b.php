    ...
    <div class="main-wrapper">
      ...
      <div class="header-left">
        <a href="/dashboard" class="logo" style="text-decoration: none">
          ...
          <img src="/uploads/<?php echo $schoolinfo->school_logo; ?>" width="30" height="45" alt=""> <span style="text-transform: uppercase;"><?php echo $schoolinfo->school_contact_person; ?></span>
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                      <span class="avatar">
                        <img alt="John Doe" src="<?php echo e(asset('assets/img/user.jpg')); ?>" class="img-fluid">
                      </span>
 ...
 <?php /**PATH C:\xampp\htdocs\apps\school\resources\views/inc/navbar.blade.php ENDPATH**/ ?>