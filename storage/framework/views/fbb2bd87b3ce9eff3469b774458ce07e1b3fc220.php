            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="<?php echo e(request()->is('dashboard/emails/inbox') ? 'active' : ''); ?>">
                            <a href="/dashboard/emails/inbox">Inbox <span class="mail-count">(21)</span></a>
                        </li>
                        <li class="<?php echo e(request()->is('dashboard/emails/starred') ? 'active' : ''); ?>">
                            <a href="/dashboard/emails/starred">Starred</a>
                        </li>
                        <li class="<?php echo e(request()->is('dashboard/emails/sent') ? 'active' : ''); ?>">
                            <a href="/dashboard/emails/sent">Sent Mail</a>
                        </li>
                        <li class="<?php echo e(request()->is('dashboard/emails/draft') ? 'active' : ''); ?>">
                            <a href="/dashboard/emails/draft">Draft <span class="mail-count">(8)</span></a>
                        </li>
                        <li class="<?php echo e(request()->is('dashboard/emails/trash') ? 'active' : ''); ?>">
            ...
            </div><?php /**PATH C:\xampp\htdocs\management\school\resources\views/inc/email-menu.blade.php ENDPATH**/ ?>