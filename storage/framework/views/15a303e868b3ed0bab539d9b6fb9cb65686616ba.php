        ...
        <div class="content" style="margin-bottom: 100px">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        ...
                        <a href="" class="btn btn-default btn-rounded float-right" data-toggle="modal" data-target="#listview"><img src="<?php echo e(asset('/images/menu.png')); ?>" alt="Table" width="25px" height="25px"></a>
                    </div>
                </div>
        <div class="row doctor-grid">

                      <?php $__currentLoopData = $stafflisting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="/staff/<?php echo $stp -> staff_id; ?>"><img alt="" src="/uploads/<?php echo e($stp->image); ?>"></a>
                            </div>
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="/staff/<?php echo $stp -> staff_id; ?>"><?php echo e($stp->firstname_staff); ?> <?php echo e($stp->lastname_staff); ?></a></h4>
                            <div class="doc-prof"><?php echo e($stp->designation_staff); ?></div>
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> <?php echo e($stp->address_staff); ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo e(URL::to('staff/submit')); ?>" enctype="multipart/form-data" method="post">
 ...
 <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select name="department_staff" class="form-control" required>
        ...
        <option><?php echo e($departments->department_name); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
      </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\management\school\resources\views/staff.blade.php ENDPATH**/ ?>