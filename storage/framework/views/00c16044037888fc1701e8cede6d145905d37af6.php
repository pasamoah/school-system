                            ...
                            <div class="email-content">
								<div class="table-responsive">
									<table class="table table-inbox table-hover">
										...
										<tbody>
											<?php $__currentLoopData = $sent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr class="unread clickable-row" data-href="mail-view.html">
												...
												<td class="name"><?php echo $sent->sms_number; ?></td>
												<td class="subject"><?php echo substr($sent -> sms_message,0,60); ?>...</td>
												<td><i class="fa fa-paperclip"></i></td>
												<td class="mail-date"><?php echo e($sent -> created_at->diffForHumans()); ?></td>
											</tr>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\management\school\resources\views/sent-sms.blade.php ENDPATH**/ ?>