                    ...
                    <div class="table-responsive" id="academic_year_list" style="background-color: #ffffff; padding:15px">
                                    <table class="table table-striped mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td width="150">{!! $academics->academic_year!!}</td>
                                                <td width="150">{!! $academics->academic_semester!!}</td>
                                                <td>{!! $academics->academic_description!!}</td>
                                                <td class="text-right">
                                                    <div class="dropdown dropdown-action">
                                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href=""><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="/academic/delete/{!! $academics->id !!}" data-toggle="modal" data-target=""><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                                    </div>
