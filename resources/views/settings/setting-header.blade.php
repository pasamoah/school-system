...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/uploads/{!! $school->school_logo !!}" style="width: 30px; height: 45px">
    @endforeach
        ...
        <div class="header">
			<div class="header-left">
                <a href="/dashboard" class="logo">
                  ...
                  <img src="/uploads/{!! $schoolinfo->school_logo !!}" width="35" height="42" alt=""> <span>{{$schoolinfo->school_contact_person}}</span>
                  @endforeach
                </a>
            </div>
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img">
                          ...
                          @else
              <img class="rounded-circle" src="/uploads/{!! Auth::user()->admin_photo !!}" width="34" alt="Admin">
                @endif
