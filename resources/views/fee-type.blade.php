                                ...
                                <tbody>
                                  @foreach($feetype as $feetype)
                                    <tr>
                                        ...
                                        <td>{{$feetype->feetype_code}}</td>
                                        <td>{{$feetype->feetype_aca_year}}</td>
                                        <td>{{$feetype->feetype_levels}}</td>
                                        <td>{{$feetype->feetype_description}}</td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <button class="dropdown-item" id="deleteProduct" data-id="{!! $feetype->id !!}" data-token="{{csrf_token()}}"><i class="fa fa-trash-o m-r-5"></i> Delete</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
