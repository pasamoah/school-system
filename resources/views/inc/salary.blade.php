                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
											<a href="/staff/{!!$salary->staff_id!!}"><img class="rounded-circle" src="/uploads/{{$salary->image}}" height="28" width="28" alt=""> {!! $salary->firstname_staff !!} {!! $salary->lastname_staff !!}
                                            </a>
                                        </td>
                                        <td>{!! $salary->staff_id !!}</td>
                                        <td><a href="mailto::{!! $salary->email_staff !!}">{!! $salary->email_staff !!}</a></td>
                                        <td>{!! $salary->joining_date !!}</td>
                                        <td>
                                            <div class="dropdown">
                                                <a href="#" class="custom-badge status-orange dropdown-toggle" data-toggle="dropdown" aria-expanded="false">{!! $salary->designation_staff !!}</a>
                                            </div>
                                        </td>
                                        <td>GHc {!! $salary->basic_salary !!}.00</td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="/delete/salary/{!! $salary->id !!}" data-toggle="modal" data-target=""><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
