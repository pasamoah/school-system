...
<form method="POST" action="{{URL::to('registerstudent')}}" enctype="multipart/form-data">
  {{ csrf_field() }}
<div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="number" class="form-control" placeholder="Reference Number"  required name="reference" value="{!! $ref_number !!}">
      <div class="valid-tooltip">
        Looks good!
      </div>
    </div>
    <div class="col-md-4 mb-3">
      ...
      <label data-toggle="modal" data-target="#exampleModal" class="text-primary">Create Level</label>@endif
