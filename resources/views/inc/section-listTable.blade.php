<div class="table-responsive">
							<table class="table table-striped custom-table">
								...
								<tbody>
									...
									<tr>
										<td>{!! $section_list->id !!}</td>
										<td>{!! $section_list->section_name !!}</td>
										<td>{!! $section_list->section_capacity !!}</td>
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="/section/delete/{!! $section_list->id !!}" data-toggle="modal" data-target=""><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
